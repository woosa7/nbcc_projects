...
#
# do xmu-only calculations for each pdb file in list_files
#
...
cp /homes/eta/users/chong/project_covid19/common/header_m_BX_160_NX_128.inp ./protein_BINARY.inp
...
cp /homes/eta/users/chong/project_covid19/common/header_m_BX_160_NX_128.inp ./protein_monomer_1.inp
...
cp /homes/eta/users/chong/project_covid19/common/header_m_BX_160_NX_128.inp ./protein_monomer_2.inp
